    ...
    <Card style={styles.card}>
      ...
      <Card.Content>
        <StatRow
          ...
          valueColor={realizedRR >= 1 ? theme.colors.profit : theme.colors.loss}
        />
        <StatRow
          label="Expected Value:"
          value={`$${expectedValue.toFixed(2)}/trade`}
          valueColor={hasPositiveEdge ? theme.colors.profit : theme.colors.loss}
        />
        <StatRow
          label="Required Win Rate:"
          value={requiredWinRate > 0 ? `${requiredWinRate.toFixed(1)}%` : 'N/A'}
        />
        <StatRow
          label="Win Rate Edge:"
          value={
